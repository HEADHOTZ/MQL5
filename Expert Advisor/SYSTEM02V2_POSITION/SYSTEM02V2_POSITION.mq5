            ...
            if(POSITION == L || POSITION == A)
              {
               ...
               trade.Buy(lotBuy,Symbol(),Ask,sarArray[1] - spreadSL,Ask+tpBuy,NULL);
              }
           }
            ...
            if(POSITION == S || POSITION == A)
              {
               ...
               trade.Sell(lotSell,Symbol(),Bid,sarArray[1] + spreadSL,Bid-tpSell,NULL);
              }
           }
