   ...
   if(D1  != iTime(Symbol(),PERIOD_CURRENT,0))
     {
      ...
      if(TP_BAND == false)
        ...
        {
         tpBuy = NormalizeDouble(upperBandArray[1], (int)SymbolInfoInteger(_Symbol, SYMBOL_DIGITS));
         tpSell = NormalizeDouble(lowerBandArray[1], (int)SymbolInfoInteger(_Symbol, SYMBOL_DIGITS));
        }
